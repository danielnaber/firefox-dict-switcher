...
function changeDictionary(langCode, langName)
{
    ...
    if(!langCode) {
        showFeedbackInToolbar("...", "", false);   // TODO: detailed message 
        return;
    }
    ...
    showFeedbackInToolbar(langCode, message, feedbackData.isWarning);
}
...
// TODO: once this works, remove the feedback that manipulates the page DOM
var dictSwitcherButton = ActionButton({
    ...
    onClick: function(state) {
        // there's no real action, so show some help text or open config 
    }
});
