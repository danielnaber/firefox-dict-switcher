...
function changeDictionary(language)
{
    ...
    // Ashraf: I think (with the current detection library) this only happens for Portuguese, Brazilian Portuguese
    // and Taiwan Chinese
...
function initialize(options)
{
    ...
    pageMod.PageMod({
        ...
        onAttach: function (worker)
        {
            ...
            // This solves the second issue at https://github.com/danielnaber/firefox-dict-switcher/issues/1
